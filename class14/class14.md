...
- [Data Import](#data-import)
  - [Sanity Check + Data refinement](#sanity-check--data-refinement)
...
Today we’re going to do a pathway analysis of a RNA-seq dataset using
DESeq.
...
```
    ...
    Info: Working in directory /Users/johnoh/Library/CloudStorage/OneDrive-개인/UC Exchange/8_2026SQ_Courses/BIMM 143 Introduction to Bioinformatics/bimm143_github/class14
...
![](hsa04330.pathview.png) \> Q. Can you do the same procedure as above
to plot the pathview figures for the top 5 down-regulated pathways?
...
The **Cell Cycle** pathway. These match the KEGG results, as the top
down-regulated pathway indicated in KEGG analysis was shown as
**hsa04110**, or Cell cycle pathway.

Probable reasons for differences between KEGG and REACTOME analysis: 1.
**Organism** KEGG: covers genes from various organisms / REACTOME: with
our option, we focus on human genes 2. **Type of reactions** KEGG: focus
on metabolic pathways / REACTOME: chemical reactions all covered in the
DB 3. Other reasons might include the **granularity** of a pathway (KEGG
pathway is generally larger, while REACTOME pathways are more
hierarchically segmented), or **Statistical method** used for
