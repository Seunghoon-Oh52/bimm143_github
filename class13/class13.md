...
Plan: - Find the “control” columns in our `counts` object. - Extract
just the “control” column values for all genes - Calculate the average
value per gene in these “control” columns
...
For book-keeping let’s stroe these together as a new object called
`meancounts`
...
`arr.ind=TRUE` returns array indices (row and column) of genes with only
zero values. Using these return value, we can eliminate the genes from
our dataset.
...
Now we have our annotated results with thier log2 fold-change and
p-values - we can figure our which biological pathways and process these
genes are involved with.

We will use the **gage** and **pathview** pacakgaes for this step and we
...
```
    ...
    Info: Working in directory /Users/johnoh/Library/CloudStorage/OneDrive-개인/UC Exchange/8_2026SQ_Courses/BIMM 143 Introduction to Bioinformatics/bimm143_github/class13

    Info: Writing image file hsa05310.pathview.png

![](hsa05310.pathview.png) \## Save our annotated results
